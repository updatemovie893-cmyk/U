...
ADMIN_USER_IDS = [1930138915, 1838854178]   # <-- ADD YOUR SECOND ADMIN ID HERE
...
# ------------------ Translations (English + Myanmar) ------------------
# ... (same as before, not changed)
TEXTS = {
    'en': {
...
def main_keyboard(user_id):
    lang = get_user_language(user_id)
    is_admin = (user_id in ADMIN_USER_IDS)   # <-- CHANGED
    button_labels = {
        'en': {
...
def main():
    ...
    logger.info("Bot started with multiple admins support.")
    app.run_polling()
